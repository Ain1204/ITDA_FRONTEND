...
const RequestTitle = styled.button`
    color: ${props => props.$active === "true" ? 'var(--Colors-Primary-B500, #0051FF)' : 'var(--Colors-GrayScale-G400, #949BAD)'};
    font-family: "SUIT Variable";
    font-size: 12px;
    font-style: normal;
    font-weight: 500;
    ...
    text-align: left;
    width: fit-content;
    border-bottom: 2px solid ${props => props.$active === "true" ? 'var(--Colors-Primary-B500, #0051FF)' : 'transparent'};
    margin-bottom: -2px;
    position: relative;
    z-index: 1;
...
const RequestDetail = styled.div`
    ...
    transform: translateY(${props => props.$active === "true" ? '0' : '20px'});
        ...
        <BottomContainer>
            <ProfileContainer>
                ...
                <ProfileWrapper>
                    ...
                    <ProfileInformation>
                        <ProfileName>한양대학교 ERICA 소프트웨어융합대학 학생회 SW:ING</ProfileName>
                        ...
                        <RequestWrapper>
                            {["식품/간식", "음료", "주류", "뷰티", "패션", "의료/제약", "문구/소품", "쿠폰/바우처", "기타"].map((product) => (
                                <RegisterDetailButton 
                                    ...
                                    onClick={() => handleArrayInputChange('requestedProducts', product)}
                                />
                            ))}
                        </RequestWrapper>
