...
const UploadIR = ({ title, onFilesChange, className }) => {
    ...
    return (
        <IRContainer className={className}>
            {title && (
                <LabelContainer>
            ...
            >
                <Subtext>아직 제안서를 등록하지 않은 것 같아요!</Subtext>
                <DropZoneText>제안서를 등록하고 협업을 시작해 볼까요?</DropZoneText>
